...
-- Chạy SAU migration trong phpMyAdmin
-- ============================================================
USE warehouse_db;
...
INSERT INTO categories (name) VALUES
  ('Giấy In'), ('Giấy Ảnh'), ('Giấy Bìa'),
  ('Vải Vụn'), ('Lõi Ống'),  ('Khác');
...
SELECT id, CASE code
  WHEN 'GIN-A4-80'  THEN 350  WHEN 'GIN-A3-80'  THEN 180
  WHEN 'GIN-A0-90'  THEN 45   WHEN 'GAN-BONG'   THEN 120
  WHEN 'GAN-MO'     THEN 95   WHEN 'GBI-300'    THEN 680
  WHEN 'GBI-250'    THEN 420  WHEN 'VAI-COTTON' THEN 850
  WHEN 'VAI-POLY'   THEN 620  WHEN 'LOI-3IN'    THEN 280
  ELSE 0 END
FROM products;
